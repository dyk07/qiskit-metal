...
This worktree is the **active development copy** — new features and behavior changes go here. The sibling `qiskit-metal/` tree (on branch `main`) is for reading/study and Chinese learning annotations. See the parent `../../AGENTS.md` for the workspace-wide layout.
